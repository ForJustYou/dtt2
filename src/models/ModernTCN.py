...
from src.layers.ModernTCN_Layer import series_decomp, Flatten_Head
...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        missing_fields = {
            ...
            "subtract_last": 0,
            "individual": 0,
            "kernel_size": configs.kernel,
            "patch_size": configs.patch_len,
            "patch_stride": configs.stride,
            "decomposition": 0,
        }
        for field, default_value in missing_fields.items():
            if not hasattr(configs, field):
                setattr(configs, field, default_value)
        ...
        self.drop_backbone = configs.backbone_dropout
    ...
    def forward(self, x_enc, x_mark_enc=None, x_dec=None, x_mark_dec=None, cycle_index=None):
        ...
        if self.decomposition:
            ...
            te = x_mark_enc.permute(0, 2, 1) if x_mark_enc is not None else None
